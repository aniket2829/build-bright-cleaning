...
const principles = [
  ...
  },
  {
    ...
    body: "Edmonton and the ring of towns around it, and nothing beyond, because we turn down work we cannot cover with the same person on the same schedule. That is a strange thing to advertise and the reason the rest of this works.",
  },
  {
